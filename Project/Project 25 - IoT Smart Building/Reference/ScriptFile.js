...
// Google Sheets Project Name      : Data_Monitoring
// Google Sheets ID                : 1DlS3m_wkLoZLWxiCB2YF3J6EnajFUtRyS9XN61GSNr0
// Sheet Name                      : monitoring_data

// web api spredsheet              : https://docs.google.com/spreadsheets/d/1DlS3m_wkLoZLWxiCB2YF3J6EnajFUtRyS9XN61GSNr0/edit#gid=0
...
//deployment ID : AKfycbyX2g4eSv6Jxy8BfoxwACbPbOyDEHwg1Y1ktUxRsekVTXBWOb3JiPNkRIUcRH74TtTa


// Google Apps Script Project Name : Data_Monitoring_Script

// Web app URL             : 
// https://script.google.com/macros/s/AKfycbyoWGSW1oRhOnuKKFZ5iisl20ZjmRsfiOG1HT5RIOlZqrZkBNLMm76rqdUFql2KUKSH/exec

// Web app URL Test Write : 
// ?sts=write&srs=Succes&V=11&I=10&P=4&f=5
...
function doGet(e) { 
  ...
  if (e.parameter == 'undefined') {
    ...
    var sheet_id = '1DlS3m_wkLoZLWxiCB2YF3J6EnajFUtRyS9XN61GSNr0'; 	// Spreadsheet ID.
    var sheet_name = "monitoring_data";  // Sheet Name in Google Sheets.
    ...
    // document.getElementById("demo").innerHTML = e.parameter;
